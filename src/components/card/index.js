  ...
  return (
    ...
    <div className="work-box">
      <a href="./assets/img/work-1.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox">
        <div className="work-img" style={{'width': '250px', 'height': '120px'}}>
      ...
      <div className="work-content">
        <div className="row">
          <div className="col-sm-8">
            <h2 className="w-title">{product.title}</h2>
            <div className="w-more">
              <span className="w-ctegory">{product.category}</span> / <span className="w-date">Category</span>
            </div>
          </div>
